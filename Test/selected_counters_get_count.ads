...
-- with Safe_Counters.Get_Count;
-- function Selected_Counters_Get_Count (Count: Safe_Counters.Counter) return Natural renames Safe_Counters.Get_Count;

-- with Simple_Counters.Get_Count;
-- function Selected_Counters_Get_Count (Count: Simple_Counters.Counter) return Natural renames Simple_Counters.Get_Count;
